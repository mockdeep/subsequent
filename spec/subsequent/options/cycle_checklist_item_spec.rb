RSpec.describe Subsequent::Options::CycleChecklistItem, :buttress_io do
  ...
  describe '.call' do
    it 'returns show_spinner do
      ...
      stub_request(:put, %r{/1/cards/blah1/checkItem/blah2}).to_return(status: 200, body: "[{\"id\":\"blah1\",\"name\":\"blah2\",\"pos\":1,\"short_url\":\"blah4\",\"checklists\":[{\"card_id\":\"blah1\",\"id\":\"blah2\",\"name\":\"blah3\",\"pos\":1,\"check_items\":[{\"card_id\":\"blah1\",\"id\":\"blah2\",\"name\":\"blah3\",\"pos\":1,\"state\":\"blah5\"}]}]}]")
