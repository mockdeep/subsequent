RSpec.describe Subsequent::Options::CreateChecklistItem, :buttress_io do
  ...
  describe '.call' do
    it 'returns state.with(mode: Subsequent::Modes::AddChecklistItem)' do
      stub_request(:post, %r{/1/checklists/blah2/checkItems}).to_return(status: 200, body: "[{\"id\":\"blah1\",\"name\":\"blah2\",\"pos\":\"blah3\",\"short_url\":\"blah4\",\"checklists\":[{\"card_id\":\"blah1\",\"id\":\"blah2\",\"name\":\"blah3\",\"pos\":\"blah4\",\"check_items\":[{\"card_id\":\"blah1\",\"id\":\"blah2\",\"name\":\"blah3\",\"pos\":\"blah4\",\"state\":\"blah5\"}]}]}]")
      ...
      expect(Subsequent::Options::CreateChecklistItem.call(Subsequent::State.new(cards: [Subsequent::Models::Card.new(id: 'blah1', name: 'blah2', pos: 'blah3', short_url: 'blah4', checklists: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", check_items: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", state: "blah5"}]}])], sort: Subsequent::Sorts::First, filter: Subsequent::Filters::None), 'blah2')).to eq(Subsequent::State.new(browsed_checklist: false, browse_list_id: nil, browse_page: 0, cards: [Subsequent::Models::Card.new(id: 'blah1', name: 'blah2', pos: 'blah3', short_url: 'blah4', checklists: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", check_items: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", state: "blah5"}]}])], card: Subsequent::Models::Card.new(id: 'blah1', name: 'blah2', pos: 'blah3', short_url: 'blah4', checklists: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", check_items: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", state: "blah5"}]}]), checklist: Subsequent::Models::Checklist.new(card_id: 'blah1', id: 'blah2', name: 'blah3', pos: 'blah4', check_items: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", state: "blah5"}]), checklist_items: [Subsequent::Models::ChecklistItem.new(card_id: 'blah1', id: 'blah2', name: 'blah3', pos: 'blah4', state: 'blah5')], filter: Subsequent::Filters::None, lists: [], mode: Subsequent::Modes::AddChecklistItem, sort: Subsequent::Sorts::First, tag_page: 0))
