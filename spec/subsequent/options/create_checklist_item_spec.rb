RSpec.describe Subsequent::Options::CreateChecklistItem, :buttress_io do
  ...
  describe '.call' do
    it 'returns state.with(mode: Subsequent::Modes::AddChecklistItem)' do
      stub_request(:post, %r{/1/checklists/blah2/checkItems}).to_return(status: 200, body: "[{\"id\":\"blah1\",\"name\":\"blah2\",\"pos\":\"blah3\",\"short_url\":\"blah4\",\"checklists\":[]}]")
