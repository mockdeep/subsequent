RSpec.describe Subsequent::Options::SelectList, :buttress_io do
  ...
  describe '.call' do
    it 'returns show_spinner { fetch_and_transition(state, list) }' do
      ...
      stub_request(:get, %r{/1/lists/blah1/cards}).to_return(status: 200, body: "[{\"id\":\"blah1\",\"name\":\"blah2\",\"pos\":\"blah3\",\"short_url\":\"blah4\",\"checklists\":[{\"card_id\":\"blah1\",\"id\":\"blah2\",\"name\":\"blah3\",\"pos\":\"blah4\",\"check_items\":[{\"card_id\":\"blah1\",\"id\":\"blah2\",\"name\":\"blah3\",\"pos\":\"blah4\",\"state\":\"blah5\"}]}]}]")

      expect(Subsequent::Options::SelectList.call(Subsequent::State.new(cards: [], sort: Subsequent::Sorts::First, filter: Subsequent::Filters::None, lists: [Subsequent::Models::List.new(id: 'blah1', name: 'blah2')]), '1')).to eq(Subsequent::State.new(browsed_checklist: false, browse_list_id: 'blah1', browse_page: 0, cards: [Subsequent::Models::Card.new(id: 'blah1', name: 'blah2', pos: 'blah3', short_url: 'blah4', checklists: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", check_items: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", state: "blah5"}]}])], card: Subsequent::Models::Card.new(id: 'blah1', name: 'blah2', pos: 'blah3', short_url: 'blah4', checklists: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", check_items: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", state: "blah5"}]}]), checklist: Subsequent::Models::Checklist.new(card_id: 'blah1', id: 'blah2', name: 'blah3', pos: 'blah4', check_items: [{card_id: "blah1", id: "blah2", name: "blah3", pos: "blah4", state: "blah5"}]), checklist_items: [Subsequent::Models::ChecklistItem.new(card_id: 'blah1', id: 'blah2', name: 'blah3', pos: 'blah4', state: 'blah5')], filter: Subsequent::Filters::None, lists: [Subsequent::Models::List.new(id: 'blah1', name: 'blah2')], mode: Subsequent::Modes::Normal, sort: Subsequent::Sorts::First, tag_page: 0))
